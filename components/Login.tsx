...
import { auth, googleProvider, sendPasswordResetEmail } from '../services/firebaseService';
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        if (isResetting) {
            ...
            try {
                ...
                setError("Error al enviar correo. Verifica que la dirección sea correcta.");
            } finally {
                setLoading(false);
            }
            return;
                ...
                {unauthorizedDomain ? (
                    ...
                    <>
                        ...
                        <form onSubmit={handleEmailAuth} className="space-y-5">
                            ...
                            >
                                {loading ? <Spinner /> : (isResetting ? 'Enviar Correo de Recuperación' : (isSignUp ? 'Crear Cuenta' : 'Iniciar Sesión'))}
                            </button>
                        </form>
